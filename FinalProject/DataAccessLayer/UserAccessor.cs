...
namespace DataAccessLayer
{
    public class UserAccessor : IUserAccessor
    {
        ...
        public List<string> SelectRolesByUserID(int userID)
        {
            ...
            // parameter (from sp)
            cmd.Parameters.Add("@UserID", SqlDbType.Int);   // this is what the type of the parameter is, cant specify length of int
        ...
        public User SelectUserByEmail(string email)
        {
            ...
            try
            {
                ...
                if(reader.HasRows)
                {
                    ...
                    reader.Read();
                    // [userID], [GivenName], [FamilyName], [PhoneNumber], [Email]

                    user.UserID = reader.GetInt32(0);
                    user.GivenName = reader.GetString(1);
                    user.FamilyName = reader.GetString(2);
                    user.GamerTag = reader.GetString(3);
